...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle
                text1="Contact TechSphere AI"
                text2="Let’s Build with AI"
                text3="Have a question about AI learning, JavaScript, or team plans? Reach out to TechSphere AI and let’s innovate together."
            />
            ...
            >
                ...
                >
                    ...
                    <textarea
                        name="message"
                        rows={8}
                        placeholder="Tell us about your AI learning goals, project idea, or team requirements"
