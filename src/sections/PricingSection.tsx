...
export default function PricingSection() {
    return (
        <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle
                text1="TechSphere AI Pricing"
                text2="AI-Powered Learning Plans"
                text3="Smart pricing built for developers learning JavaScript with AI — from beginners to teams."
            />
