...
export default function FeaturesSection() {
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1="Features"
        text2="Why TechSphere AI"
        text3="Smart AI tools, clean workflows, and production-ready intelligence."
      />
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        <div className="absolute -z-50 size-100 -top-10 -left-20 aspect-square rounded-full bg-pink-500/40 blur-3xl" />
        ...
        >
          TechSphere AI accelerates your workflow by converting ideas into
          intelligent outputs — powered by automation, analytics, and modern AI.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            <img
              ...
              alt="TechSphere AI dashboard preview"
              width={1000}
              height={500}
            />
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Smarter decisions with real-time AI insights
            </h3>

            <p className="text-slate-300 mt-2">
              Use intelligent analysis to optimize performance, speed up
