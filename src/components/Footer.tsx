        ...
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <p className="max-w-60">
                    AI-powered learning for modern JavaScript developers.
                </p>

                {/* Social icons (visual only, no links) */}
                <div className="flex items-center gap-4 mt-3 text-gray-400">
                    <DribbbleIcon className="size-5 hover:text-pink-500 cursor-pointer" />
                    <LinkedinIcon className="size-5 hover:text-pink-500 cursor-pointer" />
                    <TwitterIcon className="size-5 hover:text-pink-500 cursor-pointer" />
                    <YoutubeIcon className="size-6 hover:text-pink-500 cursor-pointer" />
                </div>

                <p className="mt-3 text-center">
                    &copy; {new Date().getFullYear()} TechSphere AI
                </p>
            </motion.div>
        </footer>
    );
